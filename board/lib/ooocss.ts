...
.oo-brand{display:flex;align-items:center;gap:9px;margin-bottom:8px}
.oo-brand img{height:24px;width:auto;display:block;mix-blend-mode:multiply}
.oo-brand span{font-size:11.5px;font-weight:700;letter-spacing:1.1px;text-transform:uppercase;color:#2f6f43}
...
/* Quiet confirmation that storage is reachable — hovering it names the mechanism. */
.oo-conn{font-size:12.5px;font-weight:600;color:#1b7a3f;margin:8px 0 0}
...
.oo-team{font-size:12px;font-weight:600;color:#7b8698;background:#f1f4f9;border-radius:7px;padding:3px 9px;flex:0 0 auto}
...
.oo-form select,.oo-form input{font:400 17px/1.2 "Helvetica Neue",Helvetica,Arial,sans-serif;color:var(--ink);background:#fff;
